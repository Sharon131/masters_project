 ...
 *  */
int cordic_calc( u32* angles, u32 input_len, u32 output_len, u32* output_state, u32 *nbr_of_results )
{
...
//u32 results = 0;
	...
	if( send_buffer(angles, input_len * sizeof(u32)) == XST_FAILURE )
		goto error;
	//Get results
    if( receive_buffer(output_state, output_len*sizeof(u32), nbr_of_results) == XST_FAILURE )
		goto error;
